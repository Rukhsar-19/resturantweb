...
const Header = () => {
    ...
    return (
        <>
            <ContactModal show={showContact} handleClose={handleCloseContact} />
                            ...
                            <div className="col-lg-4">
                                <div className="lastheader">
                                    ...
                                    <div className="headerbtn">
                                        <button className="greenbtn" onClick={handleShowContact}><i className="ri-phone-line phonesize"></i>Contact</button>
                                    </div>
                                </div>
                            </div>
                        </div>
